...
export async function generatePDF(quotationData?: any, form?: any) {
  // Dynamically import jsPDF from browser build and html2canvas to avoid SSR issues
  ...
  if (quotationData) {
    // This would need to be handled differently, perhaps pass the updated HTML
    console.log('Using quotation data for PDF');
  }
